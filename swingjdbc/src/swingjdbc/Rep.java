	...
	jb1.addActionListener(new ActionListener() 
	{
		public void actionPerformed(ActionEvent e) 
		{
			try 
			{
				...
				Connection conn =    DriverManager.getConnection("jdbc:mysql://localhost:3306/rep", "root", "root");
				if (conn != null)
				{
					...
					int commission = Integer.parseInt(jtf14.getText());
					int rate = Integer.parseInt(jtf15.getText());
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				Connection conn = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/rep", "root", "root");
				if (conn != null) 
				{
					stmt = (Statement) conn.createStatement();
					String query3="SELECT * FROM Representative WHERE Repno IN (SELECT Repno FROM Customer WHERE cred > 15000 )";
